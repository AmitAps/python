...
#Import tkinter
from tkinter import *
#Remember to import the necessary module.
...
def save_data():
    ...
    try:
    #Note: This code is indented under the "try" statement.
    ...
    #If an exception is thrown ANYWHERE in ABOVE section, the computer will jump to the code HERE.
    except Exception as ex: #Inside the handler, the exception is assigned to a variable called "ex".
        #This is the exception handler code.
                                          #We're using format strings to display the exception in the title.
        #The exception handler cam have several lines as long as they are all indented in the same way.
